...
use casper_types::{
    ...
    HostFunctionCostsV1, HostFFIFunctionCosts, Key, MessageLimits, OpcodeCosts, ProtocolVersion,
...
static NEW_HOST_FUNCTION_COSTS_V2: Lazy<HostFFIFunctionCosts> = Lazy::new(HostFFIFunctionCosts::zero);
